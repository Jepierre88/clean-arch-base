...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-lg border border-border/60 bg-background/80 px-4 text-sm font-medium text-foreground shadow-[0_1px_2px_rgba(15,23,42,0.08)] transition-colors",
        "py-2 data-[size=default]:h-11 data-[size=sm]:h-9",
